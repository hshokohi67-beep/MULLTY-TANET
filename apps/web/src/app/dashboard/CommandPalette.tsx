...
const PAGE_KEYWORDS: Record<string, string> = {
  ...
  '/dashboard/marketplace': 'بازارگاه خوراک گردی کافه گردی معرفی کافه نمایش عمومی جستجو شهر',
  '/dashboard/sms': 'پیامک اس ام اس کمپین پیام خودکار پنل پیامکی کاوه نگار ملی پیامک',
  '/dashboard/help': 'راهنما آموزش کمک چطور سوال راهنمای کامل',
  '/dashboard/ads': 'تبلیغات تبلیغ بنر کمپین آگهی خوراک گردی نمایش کلیک',
  '/dashboard/billing': 'اشتراک پلن پرداخت صورتحساب فاکتور تمدید ارتقا افزونه',
