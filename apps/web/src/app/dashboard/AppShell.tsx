...
import {
  ...
  LifeBuoy, Megaphone, Search, Settings, ShoppingCart, Store, Tags, Truck, UserCog, Users, UtensilsCrossed, Wallet, X, type LucideIcon,
} from 'lucide-react';
...
const ICONS: Record<string, LucideIcon> = {
  overview: LayoutDashboard, reports: BarChart3, marketplace: Compass, ads: Megaphone, help: LifeBuoy, orders: ReceiptText, kitchen: ChefHat, tables: Armchair, menu: UtensilsCrossed,
