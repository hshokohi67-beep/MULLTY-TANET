import {
  ...
  ReceiptText, Rocket, Search, Settings, ShieldCheck, ShoppingCart, Smartphone, Store, Tags, Truck, UserCog, UserRound, Users, UtensilsCrossed, Wallet, Aperture,
  type LucideIcon,
} from 'lucide-react';
...
const ICONS: Record<Key, LucideIcon> = {
  ...
  stories: Aperture, delivery: Truck, marketplace: Compass, ads: Megaphone, inventory: Boxes, purchases: ShoppingCart, staff: CalendarClock,
